  ...
  return (
      ...
      <div className="lg:w-[400px] px-3 py-4 flex flex-col justify-center items-center bg-stone-900 text-white rounded shadow shadow-white w-[300px] ">
        <div className="flex gap-1">
          <input
            type="text"
            className="py-2 px-1 mb-5 rounded bg-black lg:w-[260px] text-white shadow shadow-[#f71212] outline-none focus:transition-colors focus:enabled:shadow-teal-600 focus:duration-500 focus:delay-500"
        ...
        {(moveieName.Response === 'False') ? <div className="text-2xl bg-gradient-to-tr from-white  to-black bg-clip-text text-transparent font-bold">Movie is Not Fount!</div> : (isloading) ? (
          <div className="text-2xl bg-gradient-to-tr from-white  to-black bg-clip-text text-transparent font-bold">Loading....</div>
        ) : (
